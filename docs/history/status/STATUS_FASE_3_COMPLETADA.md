...
- `backend/app.py` - Try/except imports
- `backend/core/db.py` - Try/except imports
- `backend/routes/planner.py` - Try/except imports
- `backend/routes/auth.py` - Try/except imports
- `backend/routes/solicitudes.py` - Try/except imports
- `backend/routes/admin.py` - Try/except imports
- `backend/routes/catalogos.py` - Try/except imports
- `backend/routes/materiales.py` - Try/except imports
- `backend/routes/materiales_detalle.py` - Try/except imports
