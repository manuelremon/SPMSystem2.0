...
|---|---|---|---|
| `ImportError: No module named 'core'` | pytest corre desde workspace root, imports relativos no funcionan | Try/except para imports absolutos (backend.core.*) | 9 archivos |
...
|---|---|---|
| `backend/core/services/planner_service.py` | Try/except imports | 7-25 |
| `backend/core/repository.py` | Try/except imports | 10-13 |
| `backend/app.py` | Try/except imports | 13-27 |
| `backend/core/db.py` | Try/except imports | 5-8 |
| `backend/routes/planner.py` | Try/except imports | 6-18 |
| `backend/routes/auth.py` | Try/except imports | 16-19 |
| `backend/routes/solicitudes.py` | Try/except imports | 9-15 |
| `backend/routes/admin.py` | Try/except imports | 10-16 |
| `backend/routes/catalogos.py` | Try/except imports | 4-7 |
| `backend/routes/materiales.py` | Try/except imports | 4-7 |
| `backend/routes/materiales_detalle.py` | Try/except imports | 5-8 |
...
```
Este patrón permite:
- ✅ pytest test discovery (usa backend.*)
