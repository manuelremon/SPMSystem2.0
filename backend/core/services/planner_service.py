...
def paso_3_guardar_tratamiento(
    ...
    # Actualizar estado: "Tratado" si todas las decisiones fueron guardadas,
    # "En tratamiento" si hubo errores parciales
    nuevo_estado = "Tratado" if guardadas == len(decisiones) else "En tratamiento"
