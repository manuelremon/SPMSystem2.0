  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        // Remove old precache entries when new SW activates (prevents 404 on stale hashed assets)
    ...
    rollupOptions: {
      output: {
        manualChunks: {
          ...
          'vendor-grid': ['@mui/x-data-grid', 'ag-grid-community', 'ag-grid-react'],
          'vendor-spreadsheet': ['@fortune-sheet/core', '@fortune-sheet/react'],
