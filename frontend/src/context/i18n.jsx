...
const translations = {
  ...
  cc_accuracy_rate: { es: "Tasa de Precisión", en: "Accuracy Rate" },
  cc_pending_counts: { es: "Conteos Pendientes", en: "Pending Counts" },
  cc_total_variance: { es: "Varianza Total", en: "Total Variance" },
  cc_pending_adjustments: { es: "Ajustes Pendientes", en: "Pending Adjustments" },
  cc_programs: { es: "Programas", en: "Programs" },
  cc_counts: { es: "Conteos", en: "Counts" },
  cc_generate: { es: "Generar Conteo", en: "Generate Count" },
  cc_start: { es: "Iniciar", en: "Start" },
  cc_complete: { es: "Completar", en: "Complete" },
  cc_system_qty: { es: "Cant. Sistema", en: "System Qty" },
  cc_counted_qty: { es: "Cant. Contada", en: "Counted Qty" },
  cc_variance: { es: "Varianza", en: "Variance" },
  cc_approve_adjustment: { es: "Aprobar Ajuste", en: "Approve Adjustment" },
